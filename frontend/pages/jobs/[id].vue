      ...
      <UCard class="mb-6">
        ...
        <template v-if="job.errorDetails">
          <div class="mt-6 p-4 bg-red-50 text-red-700 rounded-md">
            <details class="p-4 bg-red-50 text-red-700 rounded-md">
              ...
              <div class="mt-2">
                ...
                <p
                  v-if="job.errorDetails.stack_trace"
              ...
              <table class="w-full">
                ...
                <tbody class="divide-y">
                  ...
                  >
                    ...
                    <td v-if="job?.config?.include_ips" class="px-4 py-2 font-mono">
                      {{ result.ip || 'N/A' }}
                    </td>
...
const filteredSubdomains = computed(() => {
  ...
  return job.value.subdomains.filter(
    (result) =>
